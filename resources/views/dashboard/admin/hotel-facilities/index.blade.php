    ...
    <main class="h-full overflow-y-auto">
        <div class="container mx-auto">
            <div class="flex w-full gap-5 mx-auto justify-between items-center">
                ...
                <a href="{{route('dashboard.hotel_facilities.create')}}" class="mt-10 px-5 py-3 border-2 rounded-md bg-primary-100 p-2 text-primary-700 hover:bg-white transition-all duration-75 hover:text-[#976033] text-base text-center">
                            ...
                            @forelse ($hotel_facilities as $hotel_facility)
                                <tr class="cursor-pointer">
                                    ...
                                    <td class="flex items-center">
                                        <div class="mr-2">
                                            <a href="{{route('dashboard.hotel_facilities.edit', $hotel_facility)}}" class="py-2 px-2 border-2 rounded-md border-yellow-600 text-yellow-600 text-center">

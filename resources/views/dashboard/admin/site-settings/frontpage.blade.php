            ...
            <div class="container px-6 mx-auto">
                <main class="col-span-12 md:pt-0">
                    <div class="p-10 mt-2 bg-white rounded-xl shadow-lg">
                        ...
                        <form action="{{route('dashboard.site.settings.frontpage.update', $site_setting->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="flex flex-col gap-5">
                                ...
                                <div class="flex flex-col gap-5">
                                    <input type="text" name="our_service_title" id="our_service_title" value="{{$site_setting->our_service_title}}" class="rounded-lg">
                                </div>
                            ...
                            <div class="flex flex-col gap-5 my-5">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <input type="text" name="our_location_title" id="our_location_title" value="{{$site_setting->our_location_title}}" class="rounded-lg">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <textarea type="text" name="our_location_desc" id="ourLocationDesc" class="rounded-lg">{!!$site_setting->our_location_desc!!} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col gap-5 my-5">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <input type="text" name="our_facilities_title" id="our_facilities_title" value="{{$site_setting->our_facilities_title}}" class="rounded-lg">
                            ...
                            <div class="flex flex-col gap-5 my-5">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <input type="text" name="testimonial_title" value="{{$site_setting->testimonial_title}}" id="testimonial_title" class="rounded-lg">
                            ...
                            <div class="flex flex-col gap-5 my-5">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <input type="text" name="award_title" id="award_title" value="{{$site_setting->award_title}}" class="rounded-lg">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <textarea type="text" name="award_desc" id="award_desc" class="rounded-lg">{!!$site_setting->award_desc!!} </textarea>
                            ...
                            <div class="flex flex-col gap-5 my-5">
                                ...
                                <div class="grid lg:grid-cols-3 gap-5">
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <input type="text" name="cta_text" id="cta_text" value="{{$site_setting->cta_text}}" class="rounded-lg">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <input type="text" name="cta_button_text" id="cta_button_text" value="{{$site_setting->cta_button_text}}" class="rounded-lg">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <input type="text" name="cta_button_link" id="cta_button_link" value="{{$site_setting->cta_button_link}}" class="rounded-lg">
                            ...
                            <div class="flex flex-col gap-5 my-5">
                                ...
                                <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-5">
                                    <div class="flex flex-col gap-3">
                                        <img src="{{url($site_setting->hero_cover)}}" alt="" class="h-40 object-cover">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        <img src="{{url($site_setting->service_image)}}" alt="" class="h-40 object-cover">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        <img src="{{url($site_setting->faq_illustration)}}" alt="" class="h-40 object-cover">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        <img src="{{url($site_setting->cta_cover)}}" alt="" class="h-40 object-cover">

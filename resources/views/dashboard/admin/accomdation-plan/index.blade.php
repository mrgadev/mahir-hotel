        ...
        <main class="h-full overflow-y-auto">
            <div class="container mx-auto">
                <div class="flex w-full gap-5 mx-auto justify-between items-center">
                    ...
                    <a href="{{route('dashboard.accomodation_plan.create')}}" class="mt-10 px-5 py-3 border-2 rounded-md bg-primary-100 p-2 text-primary-700 hover:bg-white transition-all duration-75 hover:text-[#976033] text-base text-center">
                                ...
                                @forelse ($accomdation_plans as $accomdation_plan)
                                    <tr class="cursor-pointer">
                                        ...
                                        <td class="flex items-center">
                                            ...
                                            <form action="{{route('dashboard.accomodation_plan.destroy', $accomdation_plan)}}" class="" method="POST">
                                                @method('DELETE')
                                                @csrf
...
@push('addon-script')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const actionUrl = "{{ route('dashboard.accomodation_plan.bulkDelete') }}";

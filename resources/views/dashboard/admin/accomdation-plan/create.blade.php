            ...
            <section class="container px-6 mx-auto">
                <main class="col-span-12 md:pt-0">
                    <div class="px-2 py-2 mt-10 bg-white rounded-xl shadow-lg">
                        <form action="{{route('dashboard.accomodation_plan.store')}}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="">
                                    ...
                                    <div class="mt-10">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="md:col-span-6 lg:col-span-3">
                                                ...
                                                <input placeholder="Harga" type="number" name="price" id="password" autocomplete="off" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                                @if ($errors->has('price'))

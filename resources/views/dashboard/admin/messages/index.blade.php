                        ...
                        <tbody>
                            @forelse ($messages as $message)
                                <tr class="cursor-pointer">
                                    <td class="font-medium text-gray-900 whitespace-nowrap">{{$message->id}}</td>
                                    ...
                                    <td class="flex items-center">
                                        <div class="mr-2">
                                            <a href="{{route('dashboard.message.show', $message)}}" class="py-2 px-2 border-2 rounded-md border-primary-600 text-primary-500 text-center transition-all hover:bg-primary-500 hover:text-white">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                        </div>
                                        <form action="{{route('dashboard.message.delete', $message)}}" class="" method="POST">
                                            @method('DELETE')
                                            @csrf

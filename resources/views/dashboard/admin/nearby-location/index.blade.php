        ...
        <main class="h-full overflow-y-auto">
            <div class="container mx-auto">
                <div class="flex w-full gap-5 mx-auto justify-between items-center">
                    ...
                    <a href="{{route('dashboard.nearby_location.create')}}" class="flex items-center gap-2 mt-10 px-5 py-2 border-2 rounded-md bg-primary-100 p-2 text-primary-700 hover:bg-white transition-all duration-75 hover:text-[#976033] text-base text-center">
                                ...
                                @forelse ($nearby_locations as $nearby_location)
                                    <tr class="cursor-pointer">
                                        ...
                                        <td class="flex items-center">
                                            <div class="mr-2">
                                                <a href="{{route('dashboard.nearby_location.edit', $nearby_location)}}" class="py-2 px-2 border-2 rounded-md border-primary-600 text-primary-500 text-center transition-all hover:bg-primary-500 hover:text-white">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                            </div>
                                            <form action="{{route('dashboard.nearby_location.destroy', $nearby_location)}}" class="" method="POST">
                                                @method('DELETE')
                                                @csrf
...
@push('addon-script')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const actionUrl = "{{ route('dashboard.nearby_location.bulkDelete') }}";

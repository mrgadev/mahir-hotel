...
<style>
    /* Styling untuk navbar dengan z-index yang lebih tinggi */
    #mainNavbar.scrolled {
        position: fixed;
        top: 0;
        left: 0;
        right: 0;
        z-index: 50; /* Atur z-index agar lebih tinggi */
    ...
    /* Styling teks dan link saat navbar di-scroll */
    ...
    /* Tombol auth saat navbar di-scroll */
    ...
    /* Z-index untuk mobile menu */
    #mobileMenu {
        z-index: 40; /* Supaya tetap di bawah navbar */
    }
</style>
@endpush
...
@section('main')
<header>
    <nav class="fixed px-12 duration-500 transition-all flex items-center bg-white w-full justify-between py-6 text-black z-40" id="mainNavbar">
        <p class="text-lg text-primary-500 font-medium">Mahir Hotel</p>
        <div class="lg:flex gap-8 font-light hidden">
            <a href="#" class="hover:font-medium hover:text-primary-500">Beranda</a>
            <a href="#" class="hover:font-medium hover:text-primary-500">Promo</a>
            <a href="#" class="hover:font-medium hover:text-primary-500">Layanan Lainnya </a>
            <a href="#" class="hover:font-medium hover:text-primary-500">Kontak</a>
            <a href="#" class="hover:font-medium hover:text-primary-500">Tentang Kami</a>
        </div>
        ...
        <div class="items-center gap-3 auth-button hidden lg:flex">
            <a href="{{route('register')}}" class="bg-primary-500 text-white px-5 py-2 rounded-full transition-all">Daftar</a>
    ...
    <!-- Mobile Menu -->
    <nav class="duration-500 bg-white w-screen h-screen fixed hidden top-0 left-0 right-0 z-40 px-12" id="mobileMenu">
...
<section class="relative bg-white py-8 antialiased md:py-16">
    <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0 mt-20">
    ...
    <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
      ...
      <div class="mt-6 w-full space-y-6 rounded-t-lg shadow-lg sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
        <div class="flow-root">
            <div class="relative flex h-56 w-[28rem] cursor-pointer">
